...
public class MainActivity extends AppCompatActivity { RecyclerView recyclerView, recyclerView1;
        ...
        switch (item.getItemId()) {
            ...
            case R.id.suara:
                if (mediaPlayer.isPlaying()) {
                    ...
                    mediaPlayer.start();
                    Toast.makeText(MainActivity.this, "Suara Dari Bapak Dr. H.C Ary Ginanjar Agustian", Toast.LENGTH_SHORT).show();
